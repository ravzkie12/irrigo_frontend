        ...
        <div className="flex flex-col gap-y-5 font-noto text-gray-700">
            ...
            <div className="grid grid-cols-2 gap-16">
                <LivelihoodOption 
                    ...
                    onClickOption={ () => handleOptionClick({ name : "fishingActivity", value : "Fish Capture" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Aquaculture"
                    onClickOption={ () => handleOptionClick({ name : "fishingActivity", value : "Aquaculture" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Gleaning"
                    onClickOption={ () => handleOptionClick({ name : "fishingActivity", value : "Gleaning" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Fish Processing"
                    onClickOption={ () => handleOptionClick({ name : "fishingActivity", value : "Fish Processing" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Fish Vending"
                    onClickOption={ () => handleOptionClick({ name : "fishingActivity", value : "Fish Vending" }) }
                />
            </div>
