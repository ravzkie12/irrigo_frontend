        ...
        <div className="flex flex-col gap-y-5 font-noto text-gray-700">
            ...
            <div className="self-center w-96 flex flex-col gap-y-16">
                <LivelihoodOption 
                    ...
                    onClickOption={ () => handleOptionClick({ name : "livelihoodProduct", value : "Crops" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Livestock"
                    onClickOption={ () => handleOptionClick({ name : "livelihoodProduct", value : "Livestock" }) }
                />
                <LivelihoodOption 
                    selectedOption={ isSelected }
                    livelihoodType="Poultry"
                    onClickOption={ () => handleOptionClick({ name : "livelihoodProduct", value : "Poultry" }) }
                />
            </div>
            {
                hasError && 
