...
const ForAgri = () => {
	...
	useEffect(() => {
		userProfile.involvement_type.length
			? setIsSelected(userProfile.involvement_type)
			: setIsSelected("");
	}, []);
			...
			<div className="grid grid-cols-2 gap-16">
				...
				<LivelihoodOption
					...
					onClickOption={() =>
						handleOptionClick({
							name: "involvementType",
							value: "Formal agri-fishery courses",
						})
					}
				/>
				<LivelihoodOption
					...
					onClickOption={() =>
						handleOptionClick({
							name: "involvementType",
							value: "Non-formal agri-fishery courses",
						})
					}
				/>
				<LivelihoodOption
					...
					onClickOption={() =>
						handleOptionClick({
							name: "involvementType",
							value: "Agricultural activity participant",
						})
					}
				/>
			</div>
