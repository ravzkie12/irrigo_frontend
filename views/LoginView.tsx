...
import { loginUser, onSuccessfulAuth, retrieveAccount } from '../redux/authSlice'
...
const LoginView = () => {
    ...
    const { loginEmail, loginPassword, requestStatus } = useAppSelector((state: any) => state.authState)
    ...
    const onLoginUser = (formData: any) => {
        dispatch(loginUser({ loginEmail : formData.loginEmail, loginPassword : formData.loginPassword })).then((response) =>  {
            onShowAlert()
            ...
            <div className="relative w-full bg-white flex flex-col gap-y-8 justify-center items-center px-20">
                ...
                <div className="absolute top-10 left-10 flex justify-between items-center">
                    <div className="flex gap-x-1">
                        ...
                        <h4 className="text-4xl text-[#89644e] font-black tracking-widest">Irrigo.</h4>
                    </div>
                </div>
                <button 
                ...
                <div className="flex flex-col gap-y-1">
                    ...
                    <p className="tracking-wide">Enter account credentials to proceed with <span className="text-[#89644e] font-bold tracking-widest">Irrigo.</span></p>
                </div>
                <AuthInputField 
                    myControl={ control }
                    fieldType="text"
                ...
                />
                <p className="text-sm font-light">Don't have an account? <button className="text-[#89644e] font-medium" onClick={ () => onClickLink('/register') }>Register</button></p>
            </div>
            {/*  */}
            <div className="relative w-full bg-login bg-cover flex flex-col justify-center items-center px-10">
                ...
                <div className="z-10 flex flex-col gap-y-5">
                    ...
                    <div className="flex gap-x-1">
                        ...
                        <h4 className="text-6xl text-white font-black tracking-widest">Irrigo.</h4>
                    </div>
                    {/*  */}
                    <p className="text-xl text-white font-light tracking-wider">Soil Moisture Heat Map & Monitoring Information System</p>
                </div>
                {/*  */}
            </div>
        </div>
